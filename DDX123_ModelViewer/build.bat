...
set includes=/I"C:\dev\DDX123\third_party\DirectXTex\DirectXTex" /I"C:\dev\DDX123\DDX123_ModelViewer\code\d_core" /I"C:\dev\DDX123\DDX123_ModelViewer\code\d_dx12" /I"C:\dev\d_core" /I"C:\dev\DirectX\DirectXTK12\Inc" /I"C:\dev\DDX123\third_party\tinygltf" /I"C:\dev\DDX123\third_party\imgui" /I"C:\dev\DDX123\third_party\imgui\backends"
:: set link_libs= Winmm.lib d3d12.lib dxgi.lib dxguid.lib dxcompiler.lib kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib odbc32.lib odbccp32.lib C:\dev\DDX123\DDX123_Lib\build\d_dx12.lib
