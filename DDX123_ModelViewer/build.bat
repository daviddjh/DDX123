...
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.19041.0\x64\FXC.exe" /Od /Zi /T vs_5_1 /enable_unbounded_descriptor_tables /Fo PBRVertexShader.cso ..\code\PBRVertexShader.hlsl
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.19041.0\x64\FXC.exe" /Od /Zi /T ps_5_1 /enable_unbounded_descriptor_tables /Fo PBRPixelShader.cso  ..\code\PBRPixelShader.hlsl
