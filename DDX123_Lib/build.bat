...
set flags=/Fed_dx12 /MDd /FAs /EHsc /c
set code=..\code\d_dx12.cpp
set includes=/I"C:\dev\DDX123\third_party\DirectXTex\DirectXTex" /I"C:\dev\DDX123\DDX123_Lib\code" /I"C:\dev\d_common" /I"C:\dev\DirectX\DirectXTK12\Inc"
