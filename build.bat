...
set flags= /std:c++20 /permissive /FeDDX123 /FAs /EHsc
...
set link_libs= Winmm.lib d3d12.lib dxgi.lib dxguid.lib ole32.lib oleaut32.lib Advapi32.lib crypt32.lib ..\third_party\dxc\lib\x64\dxcompiler.lib
